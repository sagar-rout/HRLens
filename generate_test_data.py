...
POSITIONS = [
    "Software Engineer", "HR Manager", "Financial Analyst", "Marketing Specialist",
    "Sales Representative", "Operations Manager", "Legal Counsel", "Research Scientist"
]

EMPLOYMENT_TYPES = ["Full-time", "Part-time", "Contract", "Intern", "Consultant"]
EMPLOYMENT_STATUS = ["Active", "Inactive", "On Leave", "Terminated"]
LEAVE_TYPES = ["Annual Leave", "Sick Leave", "Maternity Leave", "Paternity Leave", "Unpaid Leave"]
...
def generate_salary_history(base_salary):
    ...
    for _ in range(random.randint(1, 4)):
        history.append({
            ...
            "reason": random.choice(["Promotion", "Annual Review", "Market Adjustment"])
        })
...
def main():
    ...
    print(f"Successfully generated and indexed 1000 employee records in index: {settings.elasticsearch_index}")
